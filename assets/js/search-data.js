...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-joine-nus-as-a-research-fellow",
          title: 'I joine NUS as a research fellow.',
          description: "",
          section: "News",},{id: "projects-aerial-manipulator",
          title: 'Aerial Manipulator',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/1_aerial_manipulator/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%65%6C%65%69%64%73%6E@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-facebook',
        title: 'Facebook',
        section: 'Socials',
        handler: () => {
          window.open("https://facebook.com/100006467367683", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/heleidsn", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/lei-he-a7a42599", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=QGwYalkAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
